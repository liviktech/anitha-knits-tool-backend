...
const definition: swaggerJsdoc.OAS3Definition = {
  ...
  tags: [
    ...
    },
    {
      name: 'Lookups',
      description:
        'Master data for populating dropdowns across the production entry forms.',
    },
    {
      name: 'Dashboard',
      description:
        'Aggregated KPIs for management-facing dashboards (PRD §16.10).',
    },
    {
      name: 'Inventory',
      description:
    ...
    },
    {
      name: 'Load Sent',
      description:
        'Load Sent records — the outward-load operation (PRD terminology "Load Sent"). Full CRUD.',
    },
    {
      name: 'Kora Balance',
      description:
  ...
  components: {
    schemas: {
      SignupRequest: {
        ...
        properties: {
          ...
          companyCode: {
            ...
            maxLength: 50,
            example: 'AK001',
            description: 'Issued by a Super Admin; not generated by this API.',
          },
          adminMobile: {
            type: 'string',
            example: '9876543210',
      ...
      CompanyUpdateRequest: {
        type: 'object',
        description:
          'Every field is optional, but at least one must be present. Excludes adminPasswordHash — resetting the admin password is a separate concern.',
        minProperties: 1,
        additionalProperties: false,
        properties: {
      ...
      PlatformAdminUserSummary: {
        type: 'object',
        description:
          'A user belonging to a company, as seen by a platform admin (all roles, unlike the tenant-side UserSummary).',
        properties: {
          id: { type: 'string', format: 'uuid' },
      ...
      PlatformAdminUserListResponse: {
        ...
        properties: {
          ...
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/PlatformAdminUserSummary' },
          },
          meta: { $ref: '#/components/schemas/PaginationMeta' },
        },
      },
      ...
      RefreshResponse: {
        type: 'object',
        description:
          'Shared by /company/auth/refresh and /platform/admin/refresh. Also sets fresh httpOnly access/refresh cookies.',
        properties: {
          success: { type: 'boolean', example: true },
          data: {
            type: 'object',
      ...
      CompanyUserSummary: {
        type: 'object',
        description:
          'A MANAGER/SUPERVISOR user managed through this endpoint. For the full roster (all roles) see GET /api/v1/company/user/all.',
        properties: {
          id: { type: 'string', format: 'uuid' },
          companyId: { type: 'string', format: 'uuid' },
          name: { type: 'string', nullable: true },
      ...
      CompanyUserListResponse: {
        ...
        properties: {
          ...
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/CompanyUserSummary' },
          },
          meta: { $ref: '#/components/schemas/PaginationMeta' },
        },
      },
      CompanyUserUpdateRequest: {
        type: 'object',
        description:
          'Every field is optional, but at least one must be present. Excludes password/mobile — those are separate concerns.',
        minProperties: 1,
        additionalProperties: false,
        properties: {
          name: { type: 'string', maxLength: 150 },
      ...
      ExtruderDetail: {
        ...
        properties: {
          ...
          colorConsumedKg: {
            ...
            example: 0.15,
            description:
              "Auto-computed from the colour's configured standard unless overridden.",
          },
          yarnOutputKg: { type: 'number', format: 'decimal', example: 24 },
          isRecipeOverridden: {
            type: 'boolean',
            description:
              'True when colorConsumedKg deviates from the configured standard.',
          },
          overrideReason: {
            type: 'string',
            nullable: true,
            description:
              'Required and stored only when isRecipeOverridden is true.',
          },
      ...
      ExtruderProduction: {
        type: 'object',
        description:
          'A production record for the Extruder stage, with its ExtruderDetail embedded.',
        properties: {
          id: { type: 'string', format: 'uuid' },
          ...
          wastages: {
            type: 'array',
            items: { $ref: '#/components/schemas/WastageRecordSummary' },
          },
          createdAt: { type: 'string', format: 'date-time' },
      ...
      ExtruderCreateRequest: {
        ...
        properties: {
          ...
          colorConsumedKg: {
            ...
            exclusiveMinimum: 0,
            description:
              "Optional. Omit to auto-compute from the colour's configured standard.",
          },
          ...
          overrideReason: {
            ...
            maxLength: 500,
            description:
              'Required only if colorConsumedKg deviates from the configured standard.',
          },
          yarnWasteKg: {
            type: 'number',
            minimum: 0,
            description:
              'Optional. Creates a WastageRecord (code YARN_WASTE) only if > 0.',
          },
          lumpsKg: {
            type: 'number',
            minimum: 0,
            description:
              'Optional. Creates a WastageRecord (code LUMPS) only if > 0.',
          },
          bagCount: {
            type: 'integer',
            minimum: 0,
      ...
      ExtruderUpdateRequest: {
        type: 'object',
        description:
          'Every field is optional, but at least one must be present. No approval workflow — always allowed. Inventory is re-adjusted for any changed brand/chemical/colour or quantity.',
        minProperties: 1,
        additionalProperties: false,
        properties: {
          ...
          yarnWasteKg: {
            ...
            minimum: 0,
            description:
              'Omit to leave unchanged, 0 to clear, positive to set/replace.',
          },
          lumpsKg: {
            type: 'number',
            minimum: 0,
      ...
      ExtruderListResponse: {
        ...
        properties: {
          ...
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/ExtruderProduction' },
          },
          meta: { $ref: '#/components/schemas/PaginationMeta' },
        },
      },
      ...
      WastageRecordSummary: {
        type: 'object',
        description:
          'A WastageRecord created alongside its parent production record (PRD §9/§26).',
        properties: {
          id: { type: 'string', format: 'uuid' },
          wastageType: {
            type: 'object',
          ...
          color: {
            ...
            nullable: true,
            description:
              'Set only for colour-tracked wastage types (currently BW / "Bit Wastage").',
          },
      ...
      LoomsProduction: {
        type: 'object',
        description:
          'A production record for the Looms stage, with its LoomDetail embedded.',
        properties: {
          id: { type: 'string', format: 'uuid' },
      ...
      LoomsCreateRequest: {
        ...
        properties: {
          ...
          loomsWasteKg: {
            ...
            minimum: 0,
            description:
              'Optional. Creates a WastageRecord (code LOOMS_WASTE) only if > 0.',
          },
        },
      },
      LoomsUpdateRequest: {
        type: 'object',
        description:
          'Every field is optional, but at least one must be present. No approval workflow — always allowed.',
        minProperties: 1,
        additionalProperties: false,
        properties: {
          productionDate: { type: 'string', format: 'date' },
      ...
      LoomsListResponse: {
        ...
        properties: {
          ...
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/LoomsProduction' },
          },
          meta: { $ref: '#/components/schemas/PaginationMeta' },
        },
      },
      FabricCheckDetail: {
        ...
        properties: {
          fabricInputKg: {
            ...
            format: 'decimal',
            example: 192,
            description: 'Total fabric weight received for checking.',
          },
          outputKg: {
            type: 'number',
            format: 'decimal',
            nullable: true,
            example: 170,
            description: 'Final stock / output weight.',
          },
        },
      },
      FabricCheckingRecord: {
        type: 'object',
        description:
          'A production record for the Fabric Checking stage, with its FabricCheckDetail embedded.',
        properties: {
          id: { type: 'string', format: 'uuid' },
      ...
      FabricCheckingCreateRequest: {
        ...
        properties: {
          ...
          fwKg: {
            ...
            minimum: 0,
            description:
              'Optional. Creates a WastageRecord (code FW) only if > 0.',
          },
          bwKg: {
            type: 'number',
            minimum: 0,
            description:
              "Optional. Creates a colour-tracked WastageRecord (code BW, colorId = this record's colorId) only if > 0.",
          },
        },
      },
      FabricCheckingUpdateRequest: {
        type: 'object',
        description:
          'Every field is optional, but at least one must be present. No approval workflow — always allowed. Does not re-edit fwKg/bwKg wastage.',
        minProperties: 1,
        additionalProperties: false,
        properties: {
          productionDate: { type: 'string', format: 'date' },
      ...
      FabricCheckingListResponse: {
        ...
        properties: {
          ...
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/FabricCheckingRecord' },
          },
          meta: { $ref: '#/components/schemas/PaginationMeta' },
        },
      },
      LookupsResponse: {
        type: 'object',
        description:
          'Not wrapped in success/data like the other endpoints — returned as-is.',
        properties: {
          brands: {
            type: 'array',
      ...
      DashboardStageDaily: {
        ...
        properties: {
          ...
          wastageKg: {
            ...
            example: 0,
            description:
              'Summed from WastageRecord; 0 until the Wastage API is in use.',
          },
      ...
      DashboardStageSummary: {
        type: 'object',
        description:
          "One stage's totals across the whole requested date range.",
        allOf: [
          { $ref: '#/components/schemas/DashboardStageDaily' },
          {
            ...
            properties: {
              efficiencyPct: {
                type: 'number',
                example: 94,
                description: 'outputKg / inputKg * 100.',
              },
            },
          },
        ],
        ...
        properties: {
          ...
          summary: {
            ...
            properties: {
              ...
              fabricChecking: {
                $ref: '#/components/schemas/DashboardStageSummary',
              },
            },
          },
          daily: {
            type: 'array',
            description:
              'Backs the day-wise table. Only days with at least one production record appear here.',
      ...
      DashboardInventoryTypeSummary: {
        type: 'object',
        description:
          'Inventory balances of one type (HDPE/CHEMICAL/COLOR) touched during the month.',
        properties: {
      ...
      DashboardInventorySummary: {
        ...
        properties: {
          ...
          CHEMICAL: {
            $ref: '#/components/schemas/DashboardInventoryTypeSummary',
          },
      ...
      DashboardLoadSentSummary: {
        ...
        properties: {
          items: {
            type: 'array',
            items: { $ref: '#/components/schemas/LoadSentRecord' },
          },
          totals: {
            type: 'object',
            properties: {
          ...
          byVariant: {
            type: 'array',
            items: {
              $ref: '#/components/schemas/DashboardLoadSentVariantSummary',
            },
          },
        },
      },
      ...
      DashboardFabricProductionSummary: {
        type: 'object',
        description:
          'Fabric Checking output for the month, colour+size variant-wise plus an overall total.',
        properties: {
          byVariant: {
            type: 'array',
            items: {
              $ref: '#/components/schemas/DashboardFabricProductionVariantSummary',
            },
          },
          overall: {
            type: 'object',
      ...
      DashboardWastageCategorySummary: {
        type: 'object',
        description:
          'One of the 5 client-terminology wastage categories (PRD §9/§26): Yarn Waste, LUMS/LUMPS, Looms Waste, FW, BW.',
        properties: {
          code: { type: 'string', example: 'YARN_WASTE' },
          name: { type: 'string', example: 'Yarn Waste' },
          stage: {
            type: 'string',
            enum: ['EXTRUDER', 'LOOMS', 'FABRIC_CHECKING', 'DELIVERY'],
          },
      ...
      DashboardMonthlyData: {
        ...
        properties: {
          ...
          fabricProduction: {
            $ref: '#/components/schemas/DashboardFabricProductionSummary',
          },
          production: {
            type: 'object',
            description:
              'Overall production totals for the month across all three stages — same shape as the "production" dashboard\'s summary cards.',
            properties: {
              extruder: { $ref: '#/components/schemas/DashboardStageSummary' },
              looms: { $ref: '#/components/schemas/DashboardStageSummary' },
              fabricChecking: {
      ...
      InventoryRecord: {
        type: 'object',
        description:
          'The current standing balance for one item — updated in place, not a per-transaction log entry.',
        properties: {
          id: { type: 'string', format: 'uuid' },
          ...
          name: {
            type: 'string',
            example: 'Reliance',
            description: 'Auto-filled from the linked brand/chemical/colour.',
          },
          weightKg: {
            type: 'number',
            format: 'decimal',
            example: 250,
            description: 'Current balance on hand.',
          },
          DC_NUMBER: {
            type: 'string',
            example: 'DC1234',
            description: 'Distribution Center / delivery challan number.',
          },
          brand: {
            allOf: [{ $ref: '#/components/schemas/MasterDataRef' }],
            nullable: true,
            description: 'Set when type is HDPE.',
          },
          chemical: {
            allOf: [{ $ref: '#/components/schemas/MasterDataRef' }],
            nullable: true,
            description: 'Set when type is CHEMICAL.',
          },
          color: {
            allOf: [{ $ref: '#/components/schemas/MasterDataRef' }],
            nullable: true,
            description: 'Set when type is COLOR.',
          },
          createdAt: { type: 'string', format: 'date-time' },
          createdBy: { type: 'string' },
          updatedAt: { type: 'string', format: 'date-time' },
      ...
      InventoryCreateRequest: {
        type: 'object',
        description:
          "Manual stock intake. quantityKg is added to the item's current balance. Exactly one of brandId/chemicalId/colorId is required, matching type.",
        ...
        properties: {
          ...
          brandId: {
            type: 'string',
            format: 'uuid',
            description: 'Required when type is HDPE.',
          },
          chemicalId: {
            type: 'string',
            format: 'uuid',
            description: 'Required when type is CHEMICAL.',
          },
          colorId: {
            type: 'string',
            format: 'uuid',
            description: 'Required when type is COLOR.',
          },
      ...
      InventoryUpdateRequest: {
        type: 'object',
        description:
          'Manual correction of a balance already on file. Every field is optional, but at least one must be present. Item identity (type/brandId/chemicalId/colorId) cannot be changed.',
        minProperties: 1,
        additionalProperties: false,
        properties: {
          date: { type: 'string', format: 'date' },
      ...
      InventoryStockItem: {
        ...
        properties: {
          ...
          intakeKg: {
            type: 'number',
            description:
              'Current inventory balance (total stock intake on file).',
          },
          consumedKg: {
            type: 'number',
            description: 'Total drawn down by extruder production.',
          },
          stockKg: {
            type: 'number',
            description:
              'intakeKg minus consumedKg. Can go negative if consumption was never backed by an intake.',
          },
        },
      },
      InventoryStockSummary: {
        ...
        properties: {
          rawMaterial: {
            type: 'array',
            items: { $ref: '#/components/schemas/InventoryStockItem' },
            description: 'One entry per brand on file for the company.',
          },
          chemical: {
            type: 'array',
            items: { $ref: '#/components/schemas/InventoryStockItem' },
            description: 'One entry per chemical on file for the company.',
          },
          color: {
            type: 'array',
            items: { $ref: '#/components/schemas/InventoryStockItem' },
            description: 'One entry per colour on file for the company.',
          },
        },
      },
      ...
      LoadSentRecord: {
        type: 'object',
        description:
          'A ProductionRecord (stage=DELIVERY) with its LoadSent detail embedded.',
        properties: {
          id: { type: 'string', format: 'uuid' },
      ...
      KoraBalanceEntry: {
        type: 'object',
        description:
          'Current fabric stock for one color+size variant (fabric_output_kg - fabric_input_kg).',
        properties: {
          id: { type: 'string', format: 'uuid' },
          color: { $ref: '#/components/schemas/MasterDataRef' },
          size: { $ref: '#/components/schemas/MasterDataRef' },
      ...
      KoraBalanceListResponse: {
        type: 'object',
        description:
          'Not paginated — every color+size variant is returned in one call.',
        properties: {
          success: { type: 'boolean', example: true },
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/KoraBalanceEntry' },
          },
        },
      },
      KoraLedgerEntry: {
        ...
        properties: {
          ...
          entryType: {
            ...
            enum: ['CREDIT', 'DEBIT'],
            description:
              'CREDIT = Looms output added to balance; DEBIT = Fabric Checking input consumed from balance.',
          },
          ...
          balanceAfterKg: {
            type: 'number',
            example: 120.5,
            description: 'Running balance immediately after this entry.',
          },
          productionRecordId: {
            type: 'string',
            format: 'uuid',
            description:
              'The Looms or Fabric Checking ProductionRecord that generated this entry.',
          },
          createdAt: { type: 'string', format: 'date-time' },
          createdBy: { type: 'string' },
        },
      ...
      KoraLedgerBalance: {
        type: 'object',
        description:
          "The variant's current balance, echoed alongside the ledger page. balanceKg is 0 when no KoraBalance row exists yet for this variant.",
        properties: {
          colorId: { type: 'string', format: 'uuid' },
          sizeId: { type: 'string', format: 'uuid' },
          balanceKg: { type: 'number', example: 120.5 },
      ...
      KoraLedgerListResponse: {
        ...
        properties: {
          ...
          data: {
            type: 'array',
            items: { $ref: '#/components/schemas/KoraLedgerEntry' },
          },
    ...
    responses: {
      ValidationError: {
        description:
          'Request body/query/params failed validation (mass assignment, missing/invalid fields).',
        content: {
          'application/json': {
      ...
      NotFound: {
        description:
          'The record, or a referenced master-data id (colour/size/brand/chemical), does not exist.',
        content: {
          'application/json': {
            schema: { $ref: '#/components/schemas/ErrorResponse' },
          },
      ...
      Conflict: {
        description:
          "The request conflicts with the record's current state (e.g. insufficient stock, concurrent update).",
        content: {
          'application/json': {
            schema: { $ref: '#/components/schemas/ErrorResponse' },
          },
