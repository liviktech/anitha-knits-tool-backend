...
const RAW_MATERIALS_TAB_CODE = 'raw-materials';
...
export const createColor = asyncHandler(async (req: Request, res: Response) => {
  ...
  await assertModuleActionAllowed(role, userId, companyId, ADMIN_PANEL_MODULE_CODE, RightAction.ADD, RAW_MATERIALS_TAB_CODE);
...
export const updateColor = asyncHandler(async (req: Request, res: Response) => {
  ...
  const { companyId, actor, userId, role } = getAuthContext(req);
  await assertModuleActionAllowed(role, userId, companyId, ADMIN_PANEL_MODULE_CODE, RightAction.EDIT, RAW_MATERIALS_TAB_CODE);
...
export const deleteColor = asyncHandler(async (req: Request, res: Response) => {
  ...
  await assertModuleActionAllowed(role, userId, companyId, ADMIN_PANEL_MODULE_CODE, RightAction.DELETE, RAW_MATERIALS_TAB_CODE);
